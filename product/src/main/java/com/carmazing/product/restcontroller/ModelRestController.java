...
public class ModelRestController {
    ...
    public List<ModelSimple> modelSimples(@RequestParam(name = "modelUuids", required = true) String modelUuidsWithCommaSeparator) {
        var modelUuids = Arrays.asList(modelUuidsWithCommaSeparator.split(","));
