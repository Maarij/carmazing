...
public class CustomerCommandService {
    ...
    public Customer addAddressesToExistingCustomer(Customer customer, List<AddAddressInput> addressList) {
    ...
    public Customer addDocumentToExistingCustomer(Customer customer, String documentType, MultipartFile documentFile) {
